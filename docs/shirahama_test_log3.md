...
[manage@victor ~]$ ls -la /tmp/bravo_*.txt
-rw-rw-r-- 1 manage manage 17179  4月 24 11:29 /tmp/bravo_etc_files.txt
-rw-rw-r-- 1 manage manage 39166  4月 24 11:29 /tmp/bravo_tree_d3.txt
-rw-rw-r-- 1 manage manage     0  4月 24 11:29 /tmp/bravo_ulocal_etc.txt
-rw-rw-r-- 1 manage manage     0  4月 24 11:29 /tmp/bravo_www_tree.txt
[manage@victor ~]$ rm /tmp/bravo_etc_files.txt /tmp/bravo_tree_d3.txt /tmp/bravo_ulocal_etc.txt /tmp/bravo_www_tree.txt
[manage@victor ~]$ ls -la /tmp/bravo_*.txt
ls: '/tmp/bravo_*.txt' にアクセスできません: No such file or directory
[manage@victor ~]$ ls -la /tmp/ | grep manage
-rw-rw-r--   1 manage manage 17179  4月 24 11:10 victor_etc_files.txt
-rw-rw-r--   1 manage manage 21863  4月 24 11:10 victor_rpm_all.txt
-rw-rw-r--   1 manage manage   510  4月 24 11:18 victor_suid.txt
-rw-rw-r--   1 manage manage 38666  4月 24 11:09 victor_tree_d3.txt
-rw-rw-r--   1 manage manage 83696  4月 24 11:10 victor_www_tree.txt
[manage@victor ~]$ ls -la /tmp/ | grep manage
-rw-rw-r--   1 manage manage 17179  4月 24 11:10 victor_etc_files.txt
-rw-rw-r--   1 manage manage 21863  4月 24 11:10 victor_rpm_all.txt
-rw-rw-r--   1 manage manage   510  4月 24 11:18 victor_suid.txt
-rw-rw-r--   1 manage manage 38666  4月 24 11:09 victor_tree_d3.txt
-rw-rw-r--   1 manage manage 83696  4月 24 11:10 victor_www_tree.txt
[manage@victor ~]$ head -20 /tmp/victor_tree_d3.txt
/
/boot
/boot/efi
/boot/efi/EFI
...
/dev/disk
/dev/disk/by-label
[manage@victor ~]$ head -20 /tmp/victor_www_tree.txt
/var/www
/var/www/cgi-bin
/var/www/cgi-bin/.my.cnf.6804
/var/www/cgi-bin/.mysql.6804
...
/var/www/rain/data/_data_/_default_/storage
/var/www/rain/data/_data_/_default_/domains
[manage@victor ~]$ head -20 /tmp/victor_rpm_all.txt
NetworkManager-1.40.16-15.el8_9.x86_64
NetworkManager-config-server-1.40.16-15.el8_9.noarch
...
alsa-sof-firmware-2023.09.2-1.el8.noarch
...
/usr/sbin/pam_timestamp_check
/usr/sbin/unix_chkpwd
[manage@victor ~]$ ls -la /tmp/victor_*.txt
-rw-rw-r-- 1 manage manage 17179  4月 24 11:10 /tmp/victor_etc_files.txt
-rw-rw-r-- 1 manage manage 21863  4月 24 11:10 /tmp/victor_rpm_all.txt
-rw-rw-r-- 1 manage manage   510  4月 24 11:18 /tmp/victor_suid.txt
-rw-rw-r-- 1 manage manage 38666  4月 24 11:09 /tmp/victor_tree_d3.txt
-rw-rw-r-- 1 manage manage 83696  4月 24 11:10 /tmp/victor_www_tree.txt
[manage@victor ~]$ 
[manage@victor ~]$ sudo lsof /tmp/victor_*.txt 2>/dev/null
[sudo] manage のパスワード:
[manage@victor ~]$ fuser /tmp/victor_*.txt 2>/dev/null
[manage@victor ~]$ history | grep -E "victor_(tree|etc|rpm|suid|www)"
   48  11:39 head -20 /tmp/victor_tree_d3.txt
   49  11:39 head -20 /tmp/victor_www_tree.txt
   50  11:39 head -20 /tmp/victor_rpm_all.txt
   51  11:39 cat /tmp/victor_suid.txt
[manage@victor ~]$ Failed to fetch shop: Not Found
-bash: Failed: コマンドが見つかりません
[manage@victor ~]$ 
[manage@victor ~]$ head -20 /tmp/victor_etc_files.txt
/etc/fstab
/etc/crypttab
/etc/dnf/modules.d/httpd.module
/etc/dnf/modules.d/nginx.module
...
/etc/dnf/protected.d/sudo.conf
/etc/dnf/protected.d/yum.conf
[manage@victor ~]$ grep -E "> /tmp/victor_" ~/.bash_history
[manage@victor ~]$ wc -l /tmp/victor_*.txt
   614 /tmp/victor_etc_files.txt
   636 /tmp/victor_rpm_all.txt
    23 /tmp/victor_suid.txt
  2355 /tmp/victor_tree_d3.txt
...
-rw-rw-r-- 1 manage manage 38666  4月 24 11:09 /tmp/victor_tree_d3.txt
-rw-rw-r-- 1 manage manage 83696  4月 24 11:10 /tmp/victor_www_tree.txt
[manage@victor ~]$ rm /tmp/victor_etc_files.txt /tmp/victor_rpm_all.txt /tmp/victor_suid.txt /tmp/victor_tree_d3.txt /tmp/victor_www_tree.txt
[manage@victor ~]$ ls -la /tmp/victor_*.txt 2>&1 
ls: '/tmp/victor_*.txt' にアクセスできません: No such file or directory
[manage@victor ~]$ ls -la /tmp/ | grep manage 
[manage@victor ~]$ ls -la /tmp/ | grep "$(whoami)" 
[manage@victor ~]$ exit
ログアウト
Connection to 10.1.6.2 closed.
> nano
